      ...
      {userProfile ? (
        <div className="absolute md:bottom-0 left-0 right-0 pt-6 pb-[120px] md:pb-6 px-3 md:px-10">
          <form onSubmit={addComment} className="flex gap-4">
            ...
            <button
              type="submit"
              className="bg-white text-sm md:text-lg text-[#F51997] border-[1px] border-[#F51997] font-semibold px-3 md:px-6 py-1 rounded-xl outline-none hover:text-white hover:bg-[#F51997]"
